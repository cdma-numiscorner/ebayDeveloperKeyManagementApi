...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => '\OpenAPI\EbayDevKeyManagementClient\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \OpenAPI\EbayDevKeyManagementClient\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \OpenAPI\EbayDevKeyManagementClient\Model\ErrorParameter[]|null $parameters An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned.
     *
     * @return self
     */
