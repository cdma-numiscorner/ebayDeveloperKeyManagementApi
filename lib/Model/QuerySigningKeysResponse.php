...
class QuerySigningKeysResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'signing_keys' => '\OpenAPI\EbayDevKeyManagementClient\Model\SigningKey[]'
    ];
     ...
     * Gets signing_keys
     *
     * @return \OpenAPI\EbayDevKeyManagementClient\Model\SigningKey[]|null
     */
     ...
     * Sets signing_keys
     *
     * @param \OpenAPI\EbayDevKeyManagementClient\Model\SigningKey[]|null $signing_keys An array of metadata information for keypairs owned by a user.
     *
     * @return self
     */
